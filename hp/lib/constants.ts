...
export const PROBLEM_SOLUTION = {
  ...
  problems: [
    ...
    },
    {
      ...
      title: "マニュアルがなく、\n毎回ゼロから説明している",
      description:
        "ノウハウが個人の頭の中だけにあり、教育や引き継ぎのたびに時間と手間がかかる",
    },
    {
      id: "problem04",
      emoji: "😮‍💨",
      title: "改善したいのに、\n日々の業務に追われて何も変わらない",
      description:
        "「いつかやろう」が積み重なり、気づけば何年も同じ非効率なやり方のまま",
    },
  ],
  solution:
    "Lark・Canvaの最前線経験と老舗企業経営の知見を持つコンサルタントが、御社の現場に合ったAI活用の仕組みをゼロから設計・定着まで伴走します",
  benefit:
    "「あの人がいないと回らない」がなくなり、チームが自走する。浮いた時間で、本当に大切な仕事に集中できるようになります",
} as const;
